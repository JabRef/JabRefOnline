...
async function seedInternal(prisma: PrismaClientT): Promise<void> {
  ...
  await prisma.user.create({
    data: {
      ...
      name: 'Alice',
      hashedPassword:
        '$argon2id$v=19$m=65536,t=3,p=4$JpPQhFOXODmSV6mebUqD1g$B2JyogUsj80kxjqiKPlFIiXF72v7SxqWdcw0C10ByhQ', // EBNPXY35TYkYXHs
    },
  })
  ...
  await prisma.group.create({
    data: {
      ...
      icon: 'fluent:production-24-filled',
      hierarchyType: GroupHierarchyType.INDEPENDENT,
      isExpanded: true,
      type: GroupType.ExplicitGroup,
      children: {
  ...
  await prisma.group.create({
    data: {
      ...
      icon: 'fluent:emoji-laugh-20-filled',
      hierarchyType: GroupHierarchyType.INDEPENDENT,
      isExpanded: true,
      type: GroupType.ExplicitGroup,
      children: {
