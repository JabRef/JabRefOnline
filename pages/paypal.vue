...
<!-- This html file is based on http://getbootstrap.com/getting-started/ -->
  ...
  <body>
    <div class="container">
        ...
        <p><b>Update</b>The <a href="https://www.paypal.com/cgi-bin/webscr?item_name=JabRef+Bibliography+Manager&cmd=_donations&lc=US&currency_code=EUR&business=donations%40jabref.org">current paypal donations page</a> also allows for monthly donations. It should not be necessary to use this form.</p>

        <h2>Reoccurring donations via PayPal</h2>

        <form method="post" action="https://www.paypal.com/cgi-bin/webscr">
            <input type="hidden" value="_xclick-subscriptions" name="cmd">
            <input type="hidden" value="donations@jabref.org" name="business">
