...
def main(environment_name: str, verbose: bool = False, secret: bool = False):
    ...
    SESSION_PASSWORD = os.environ.get("AZURE_SESSION_PASSWORD", "<Not specified>")
        ...
        site_envelope=Site(
            ...
            site_config=SiteConfig(
                ...
                app_settings=[
                    ...
                    {"name": "WEBSITE_NODE_DEFAULT_VERSION", "value": "~24.11.0"},
                    ...
                    {"name": "NUXT_SESSION_PASSWORD", "value": SESSION_PASSWORD},
